...
public class GroupListItemAdapter extends BaseAdapter {
	...
	public GroupListItemAdapter(Context context, List<GroupList> it ) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if( groupList.get(position).getupload_link()){
			holder.upload.setImageResource(R.drawable.upload);
		}else{
			holder.upload.setImageResource(R.drawable.upload_f);
		}
		if( groupList.get(position).getdownload_link()){
			holder.download.setImageResource(R.drawable.download);
		}else{
			holder.download.setImageResource(R.drawable.download_f);
		}
